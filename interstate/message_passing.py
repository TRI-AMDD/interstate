# Modified from e3nn github repo
...
class Compose(torch.nn.Module):
    ...
    def forward(
        ...
        # breakpoint()
        # x = self.first(*input)
        x = self.first(input0, input1, input2, input3, input4, input5)
...
class MessagePassing(torch.nn.Module):
    ...
    def forward(
        self, node_features, node_attr, edge_src, edge_dst, edge_attr, edge_scalars
    ) -> torch.Tensor:
